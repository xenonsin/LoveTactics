...
-- finale (data/quests/quest_the_gate_below.lua, which already lists "quest_undercroft_slot_10" among its required quests).
...
return {
    ...
    -- Clem held, left, or caved (models/temptation.lua, docs/temptation.md). A data flag rather than
    ...
    map = {
        ...
        objective = {
            ...
            opening = "conversation_undercroft_slot_10_confront",
