...
-- finale (data/quests/the_gate_below.lua, which already lists "slot_10_general_greed" among its required quests).
...
return {
    ...
    requiredQuests = { "slot_09_a_new_bank" }, -- slot 10: the line runs in order
    requiredPrestige = 3,
