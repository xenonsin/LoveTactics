...
-- one where the register of the church's glorious dead is read aloud (data/quests/cathedral/slot_05_roll_of_the_given.lua)
...
return {
    ...
    rewardRep = 30,
    rewardPrestige = 1,
    requiredQuests = { "slot_05_roll_of_the_given" }, -- slot 6: the line runs in order
    requiredPrestige = 1,
