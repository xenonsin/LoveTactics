...
return {
    ...
    -- board must show ONLY the Colosseum debut (data/quests/colosseum/slot_01_arena_debut.lua), the quest the arrival
    ...
    requiredQuests = { "slot_01_arena_debut" }, -- slot 1: the line runs in order
    requiredPrestige = 1,
