...
-- closes on when Lust offers her back to herself (data/quests/cathedral/slot_10_general_lust.lua).
--
-- `boss` on her blueprint keeps the fight honest (no execute, no Charm); her defeat recruits rather than
-- kills, exactly as the Colosseum debut keeps Saber (data/quests/colosseum/slot_01_arena_debut.lua). She fights alone: the
...
return {
    ...
    rewardRep = 30,
    rewardPrestige = 1,
    requiredQuests = { "slot_01_haunted_mill" }, -- slot 2: the line runs in order
    requiredPrestige = 1,
