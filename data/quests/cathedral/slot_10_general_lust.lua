...
-- (data/quests/the_gate_below.lua, which already lists "slot_10_general_lust" among its required quests, so the
...
return {
    ...
    requiredQuests = { "slot_09_the_saint_unmasked" }, -- slot 10: the line runs in order
    requiredPrestige = 1,
