...
-- one where the register of the church's glorious dead is read aloud (data/quests/cathedral/quest_cathedral_slot_05.lua)
...
return {
    ...
    map = {
        ...
        objective = {
            ...
            win = { type = "killAll", enemy = "the last sighting on the list" },
        },
        keyCount = 1,
    },
}
