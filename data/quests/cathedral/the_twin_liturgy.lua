...
return {
    ...
    rewardRep = 10,
    rewardPrestige = 1,
    -- Both parents, earned: "slot_03_the_praised_working" is the first mage subclass gate on its line,
    -- "slot_03_rite_of_ashes" the first priest. Holding either is impossible without them.
    requiredQuests = { "slot_03_the_praised_working", "slot_03_rite_of_ashes" },
    requiredPrestige = 1,
    map = {
        biome = "castle",
