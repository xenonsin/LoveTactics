...
return {
    ...
    difficulty = "Hard",
    sponsor = "colosseum",
    intro = "conversation_colosseum_slot_08_intro",
    outro = "conversation_colosseum_slot_08_outro",
    rewardItems = { "weapon_given_hour", "weapon_reapers_due" },
    rewardGold = 320,
    requiredQuests = { "quest_colosseum_slot_07" }, -- slot 8: the line runs in order
    requiredPrestige = 1,
    ...
    map = {
        ...
        objective = {
            ...
            win = { type = "assassinate", target = "character_warlord",
                enemy = "the house's answer to Saber" },
        },
        keyCount = 2,
    },
}
