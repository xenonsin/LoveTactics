...
--
-- What it costs Saber: nothing left to cost. She goes because it is the same crime one more time -- the
-- house feeding the sand people who never chose to be there -- and she will not let it be a show. This
-- is the last quiet before slot 10.
--
...
return {
    ...
    difficulty = "Hard",
    sponsor = "colosseum",
    intro = "conversation_colosseum_slot_09_intro",
