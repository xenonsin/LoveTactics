...
-- fight (data/quests/colosseum/slot_02_the_padded_card.lua). Tonight the player is the DRAW -- their name is the reason
...
return {
    ...
    rewardRep = 40,
    rewardPrestige = 1,
    requiredQuests = { "slot_05_the_intake" }, -- slot 6: the line runs in order
    requiredPrestige = 1,
