...
-- data/quests/colosseum/champions_challenge.lua for why naming one quest per parent is exact rather than
-- over-strict.
--
...
return {
    ...
    -- "slot_04_one_client" the first rogue. Holding either is impossible without them.
    requiredQuests = { "slot_03_warlord_keep", "slot_04_one_client" },
    requiredPrestige = 1,
    map = {
        biome = "castle",
