...
-- data/quests/alchemist/slot_08_what_ren_kept.lua at slot 8 of the Crucible's ten -- that quest is where she learns to
...
-- data/quests/colosseum/champions_challenge.lua. This one has a second, unexpressible prerequisite too: it
...
return {
    ...
    rewardRep = 10,
    rewardPrestige = 1,
    -- Both parents, earned: "slot_03_rite_of_ashes" is the first priest subclass gate on its line,
    -- "slot_04_by_the_dram" the first alchemist. Holding either is impossible without them.
    requiredQuests = { "slot_03_rite_of_ashes", "slot_04_by_the_dram" },
    requiredPrestige = 4,
    map = {
        biome = "castle",
