...
-- data/quests/alchemist/quest_alchemist_slot_08.lua at slot 8 of the Crucible's ten -- that quest is where she learns to
...
-- data/quests/colosseum/quest_colosseum_champions_challenge.lua. This one has a second, unexpressible prerequisite too: it
...
return {
    ...
    requiredQuests = { "quest_cathedral_slot_03", "quest_alchemist_slot_04" },
    requiredPrestige = 4,
    map = {
        biome = "castle",
