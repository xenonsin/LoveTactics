...
-- finale (data/quests/the_gate_below.lua, which already lists "slot_10_general_envy" among its required quests).
...
return {
    ...
    requiredQuests = { "slot_09_the_open_formula" }, -- slot 10: the line runs in order
    requiredPrestige = 4,
