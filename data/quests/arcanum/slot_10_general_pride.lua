...
-- (data/quests/the_gate_below.lua, which already lists "slot_10_general_pride" among its required quests, so the
...
return {
    ...
    requiredQuests = { "slot_09_the_next_unequalled" }, -- slot 10: the line runs in order
    requiredPrestige = 3,
