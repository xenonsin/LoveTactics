...
return {
    ...
    rewardRep = 30,
    rewardPrestige = 2,
    requiredQuests = { "slot_06_the_requisition" }, -- slot 7: the line runs in order
    requiredPrestige = 3,
    ...
    map = {
        ...
        objective = {
            ...
            composition = function(ctx)
                ...
                -- the same call data/quests/colosseum/slot_07_no_third_state.lua makes with Ira: the line's thesis is
