...
-- Saber (data/quests/colosseum/slot_01_arena_debut.lua). She fights alone: the reward IS the companion.
--
...
return {
    ...
    rewardRep = 30,
    rewardPrestige = 1,
    requiredQuests = { "slot_01_grimoire_ruins" }, -- slot 2: the line runs in order
    requiredPrestige = 3,
