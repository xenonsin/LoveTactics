...
-- kills, exactly as the Cathedral keeps Amana (data/quests/cathedral/quest_cathedral_slot_02.lua) and the Colosseum keeps
-- Saber (data/quests/colosseum/quest_colosseum_slot_01.lua). She fights alone: the reward IS the companion.
--
