...
return {
    ...
    rewardGold = 300,
    requiredQuests = { "quest_arcanum_slot_06" }, -- slot 7: the line runs in order
    requiredPrestige = 3,
    ...
    map = {
        ...
        objective = {
            ...
            composition = function(ctx)
                ...
                -- the same call data/quests/colosseum/quest_colosseum_slot_07.lua makes with Ira: the line's thesis is
