...
-- discovery (data/quests/bastion/slot_04_the_long_list.lua) -- and the muster is the ritual built on top of not asking.
--
...
return {
    ...
    rewardRep = 30,
    rewardPrestige = 1,
    requiredQuests = { "slot_05_greywatch" }, -- slot 6: the line runs in order
    requiredPrestige = 2,
