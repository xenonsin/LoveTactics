...
-- discovery (data/quests/bastion/quest_bastion_slot_04.lua) -- and the muster is the ritual built on top of not asking.
--
...
return {
    ...
    difficulty = "Normal",
    sponsor = "bastion",
    intro = "conversation_bastion_slot_06_intro",
