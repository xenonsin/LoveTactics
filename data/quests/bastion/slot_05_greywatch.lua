...
return {
    ...
    rewardRep = 25,
    rewardPrestige = 2,
    requiredQuests = { "slot_04_the_long_list" }, -- slot 5: the line runs in order
    requiredPrestige = 2,
    ...
    map = {
        ...
        objective = {
            ...
            composition = function(ctx)
                ...
                -- data/quests/bastion/slot_01_relief_column.lua, and that file's header promises he pays HERE, at
