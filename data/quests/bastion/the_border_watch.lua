...
-- the point" (the same reading data/quests/bastion/slot_03_held_position.lua takes for the knight).
--
...
return {
    ...
    rewardRep = 10,
    rewardPrestige = 1,
    -- Both parents, earned: "slot_03_held_position" is the first knight subclass gate on its line,
    -- "slot_03_the_starving_dark" the first hunter. Holding either is impossible without them.
    requiredQuests = { "slot_03_held_position", "slot_03_the_starving_dark" },
    requiredPrestige = 2,
    map = {
        biome = "forest",
