...
-- the point" (the same reading data/quests/bastion/quest_bastion_slot_03.lua takes for the knight).
--
...
return {
    ...
    difficulty = "Hard",
    sponsor = "bastion",
    rewardItems = { "utility_bound_mile" },
    rewardGold = 250,
    ...
    requiredQuests = { "quest_bastion_slot_03", "quest_hunters_lodge_slot_03" },
    requiredPrestige = 2,
    map = {
        biome = "tundra",
