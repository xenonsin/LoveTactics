...
return {
    ...
    rewardRep = 10,
    rewardPrestige = 1,
    -- Both parents, earned: "slot_03_the_starving_dark" is the first hunter subclass gate on its line,
    -- "slot_03_rite_of_ashes" the first priest. Holding either is impossible without them.
    requiredQuests = { "slot_03_the_starving_dark", "slot_03_rite_of_ashes" },
    requiredPrestige = 2,
    map = {
        biome = "forest",
