...
-- at the finale (data/quests/the_gate_below.lua, which already lists "slot_10_general_gluttony" among its
...
return {
    ...
    requiredQuests = { "slot_09_into_the_deep_wood" }, -- slot 10: the line runs in order
    requiredPrestige = 2,
