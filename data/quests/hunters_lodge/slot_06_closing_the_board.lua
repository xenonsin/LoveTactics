...
-- behind them at the end of it than it was in the morning -- the sentence data/quests/hunters_lodge/slot_05_the_silent_wood.lua
...
return {
    ...
    rewardRep = 30,
    rewardPrestige = 1,
    requiredQuests = { "slot_05_the_silent_wood" }, -- slot 6: the line runs in order
    requiredPrestige = 2,
