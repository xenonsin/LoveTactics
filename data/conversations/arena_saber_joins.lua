...
return {
    title = "Past the Gate",
    cast  = { "character_avatar", "character_knight", "character_saber" },

    script = {
        { "character_knight", "Footsteps behind us -- the same weight that put me on my back an hour ago. She followed us out.", tag = 1 },
        ...
        { "character_knight", "You unseated a sworn knight in front of a house that wanted you to win, veteran. I would far rather have that swinging beside us than waiting on the next card.", tag = 8 },
