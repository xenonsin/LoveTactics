...
-- body they have fought beside since the first street, and Amana is who is standing inside.
--
...
--      (data/status/status_champion_fixation.lua) and the ledger records it (states/game.lua's
...
--      descents, paying costs gold and costs nothing else. Amana is the one who can say that without
...
--
--   3. IT INTRODUCES AMANA, and gives her a reason to come that is not a dice roll. A healer who joins
...
--
-- WHOSE VOICE. Amana carries it -- her room, her introduction. Rowan is present and hurt; whether she
...
return {
    ...
    script = {
        ...
        { "character_amana", "PLACEHOLDER -- time sets a bone; she can set it sooner.", tag = 2 },
