...
return {
    ...
    script = {
        ...
        { "character_rowan", "Nothing to spare but thanks, and she gave that freely. A vial of solvent, pressed on you in kind: splash it and a demon cannot grip its blade.", tag = 6, id = "give", goto = "part" },
