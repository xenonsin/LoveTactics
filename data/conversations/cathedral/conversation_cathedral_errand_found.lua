...
--
-- AMANA, MET AT A MILL THE RIFT BUILT. She is the scripted first meeting of the whole game
...
-- (data/characters/character_amana.lua). She bears no edge, keeps people standing, and ends nothing, so
...
return {
    ...
    script = {
        { "character_amana", "You can lower that. I have been outside this mill since yesterday and it has not come out.", tag = 30 },
        ...
        { "character_amana", "The man inside is still turning the wheel. He does not know the water is gone.", tag = 32 },
        { "character_amana", "I carry no blade and I cannot end him. Ask me in and I will keep all of you standing while you do.", tag = 33, choices = {
