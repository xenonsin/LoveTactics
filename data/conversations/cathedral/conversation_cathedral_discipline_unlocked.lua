...
return {
    ...
    cast  = { "cathedral", "character_avatar", { id = "character_xin", when = { has = "character_xin" } } },
    ...
    script = {
        ...
        { when = { has = "character_xin" }, script = {
            { "character_xin", "The Light gives what is earned, and you earned this. Carry it gently.", tag = 3 },
        } },
    },
}
