...
-- pass -- short on purpose. What it has to establish is only the shape: Clem is standing at undercroft's
-- posting, Clem asks the company to run it, and finishing it opens that house's door. The join
...
return {
    ...
    script = {
        { "character_clem", "You are the first down here in a long while. This is {house}'s work, and it has been lying here.", tag = 1 },
        { "character_avatar", "{posting}", tag = 2 },
        { "character_clem", "I cannot finish it alone. Do it, and they will open their door to you. Ask for me there.", tag = 3 },
