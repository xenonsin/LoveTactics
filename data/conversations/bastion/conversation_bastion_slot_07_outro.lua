...
return {
    ...
    script = {
        ...
        { "character_rowan", "Late is a thing a person can carry. Late means there was a door. I did not reach it in time, and a woman was holding on the other side of it.", tag = 11 },
        { "character_rowan", "Take that away and I am not someone who was late. I am someone who built herself out of an apology to a person who never needed one.", tag = 12 },
