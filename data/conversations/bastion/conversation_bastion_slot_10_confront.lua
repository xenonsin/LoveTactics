...
return {
    ...
    cast  = { "character_general_sloth", "character_rowan" },
    ...
    script = {
        ...
        { "character_rowan", "But you never chose that post. It was issued to you. And when it came due you set it down, and you have spent fifteen years making that the truth about every post there has ever been, so that yours would stop being a thing you did.", tag = 7 },
        { "character_general_sloth", "You. Girl. You have someone standing at your back.", tag = 8 },
        { "character_general_sloth", "Look at them properly. No post is worth holding -- and that includes theirs.", tag = 9 },
        { "character_rowan", "I know what mine is worth.", tag = 10 },
