...
return {
    ...
    script = {
        ...
        { "character_rowan", "{name}, I want you to hear me say it while it is still fresh enough to be honest: I do not know what we did tonight.", tag = 3 },
        { "character_rowan", "The order said end them. So they are ended. That is the entire paperwork.", tag = 4 },
        { "character_rowan", "...", tag = 5 },
        { "character_rowan", "I was sixteen the first time I went out on a rotation. Relief column, the eastern posts. My whole duty was the water -- four skins on a mule, and I checked them at every halt like they were relics.", tag = 6 },
        ...
        { "character_rowan", "That is why I am the way I am. In case you had wondered and were too polite to ask.", tag = 10 },
        { "character_rowan", "Let's go back. I want to read that contract.", tag = 11 },
    },
}
