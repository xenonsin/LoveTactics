...
return {
    ...
    script = {
        ...
        { "character_rowan", "Good.", tag = 5 },
        { "character_rowan", "Come and stand with them, {name}. You have been taking my word for what the order is. Today you can watch it done properly.", tag = 6 },
    },
}
