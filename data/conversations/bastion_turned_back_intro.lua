...
return {
    ...
    script = {
        ...
        { "character_rowan", "Every quarter I have served, the order has wanted men like that alive and talking. You bring in a deserter, you read him the list, he goes back on the line where he is some use.", tag = 12 },
