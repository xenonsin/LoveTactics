...
return {
    ...
    script = {
        ...
        { "character_knight", "We came to fight, not to be entertainment.", tag = 2 },
        ...
        { when = { has = "character_priest" }, script = {
            { "character_priest", "Then let us be quick about it. The Light is watching, even here.", tag = 8, id = "ready" },
            { "character_mage", "Watching, and unimpressed. Open the gate.", tag = 9 },
        } },
    },
}
