-- ============================================================================
-- STALE. THIS SCENE POINTS AT A DOOR THE CITY NO LONGER HAS.
--
-- Rowan's last line sends the player to "The Rift", and `data/buildings/the_gate.lua` is deleted --
-- the campaign is the Bounty Board now (docs/bounties.md), and the hub's coaching bubble on the far
-- side of this scene already says so. The premise she states is the count's, too: the guild not
-- clearing the deep floors is the fiction models/descent.lua's tally measures, and the tally is parked.
--
-- NOT PATCHED LINE BY LINE ON PURPOSE. Swapping "The Rift" for "the Bounty Board" would leave the
-- CAUSE she explains describing a system nobody plays, which is the worse half. See
-- docs/roadmap.md's Phase 0 for what specifically has to move, and for the note that this is the third
-- time this seam has gone stale -- the handoff wants to name the ROLE rather than the building.
-- ============================================================================
