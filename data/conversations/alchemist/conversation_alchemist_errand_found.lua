...
-- pass -- short on purpose. What it has to establish is only the shape: Ren is standing at alchemist's
-- posting, Ren asks the company to run it, and finishing it opens that house's door. The join
...
return {
    ...
    script = {
        { "character_ren", "You are the first down here in a long while. This is {house}'s work, and it has been lying here.", tag = 1 },
        { "character_avatar", "{posting}", tag = 2 },
        { "character_ren", "I cannot finish it alone. Do it, and they will open their door to you. Ask for me there.", tag = 3 },
