...
-- Combat.mitigatedDamage exactly as Wet's lightning weakness and Frozen's brittleness are). It
-- does nothing whatever on its own.
--
-- ONE TAG, and that narrowness is the design (the case Vulnerable: Pierce argues in full): a vulnerability to
