-- Immune: Acid -- for a short breath, acid simply does not land. Declares `immune = { acid = true }`, which
-- Status.immuneToDamage reads and Combat.mitigatedDamage / Combat.dealFlatDamage honour by voiding any
-- `acid`-tagged hit to a true 0 -- before armor, before resist, before the raw path, and without spending
-- anything (unlike a barrier). The categorical cousin of Resistant: Acid, and deliberately NOT reachable
