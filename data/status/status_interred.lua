...
-- at their word. Nothing mends it any more -- every heal aimed at it lands as a wound of the same size,
...
-- the most reflexive decision in the game -- mend the one who is falling -- into the thing that fells
...
--
-- A body under BOTH this and an Unclosing Wound is simply not mended: the block is checked first and
...
--
-- The undead do not wear this. Being past mending is a standing fact about a corpse rather than a
...
return {
    name = "Interred",
    abbr = "Intr",
    description = "Interred: every mend lands as a wound instead.",
