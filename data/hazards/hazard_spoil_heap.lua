...
-- money, and you are open to the point while you do it (Vulnerable: Pierce) -- head down, hands full,
-- in a warren where something is always coming round the corner.
--
...
--
-- Unsided, like all terrain -- the enemy's own bodies are opened standing in it too, which turns a heap
...
-- what this does mechanically is the opening, and what it does at the table is make the tile tempting.
return {
    name = "Spoil Heap",
    description = "Inflicts Vulnerable: Pierce on units standing on it.",
    tags = { "earth" },
    duration = 24,
    disposition = "hostile",
