...
-- bearer takes no damage from it at all -- and then goes on cooldown for a spell before it can evade
...
-- on this trait's id, counted down in Combat.rebase alongside status durations). But where a counter
...
-- this reflex fires, deals 0 and starts the cooldown.
return {
    name = "Dodge",
    description = "Automatically evade a physical attack, then go on cooldown before evading again.",
    cooldown = 12,         -- ticks before it can evade again
