...
-- body (data/items/armor/mail_of_the_unappeased.lua) -- an item's `traits` reach its bearer exactly
...
return {
    ...
    onDamaged = function(ctx)
        ...
        ctx.applyStatus(ctx.unit, "wrath", { magnitude = ctx.trait.stacks * gain })
    end,
}
