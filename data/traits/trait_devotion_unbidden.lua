-- Xin's rule, and the mechanical face of devotion: "gives what is offered, refuses what is not"
...
-- trait_rapture.lua); Xin holds nothing back, so Rapture finds nothing on her and passes. The general
...
-- this rides on Xin herself and stays true once she is in your party -- which is the only time it
