-- The Shared Ledger: the standing rule of the Apothecary's charm. Anyone the bearer heals also borrows a
...
-- the healing. Combat.applyHeal is handed only a patient, which is exactly why the Crusader's
-- `allyHealed` tally lives there and this does not: one is a fact about the line, the other is a fact
-- about the healer.
--
...
--
-- Skips the bearer, so healing yourself does not lend you your own armour twice.
return {
