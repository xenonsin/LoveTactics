...
-- adjacent -- and the Priest themselves -- heals a little health (Combat.SANCTIFY_HEAL). A slow,
...
return {
    ...
    description = "Allies adjacent to you (and you) heal a little health each tick.",
}
