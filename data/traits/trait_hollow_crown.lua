...
return {
    ...
    -- The dead it reaches for, in order. As the remaining six generals are authored, put them here --
    -- this list IS the fight. Today only Wrath has been written, so the Crown falls back on the
    -- champions of the world above for the shapes it has not yet been given.
    shades = { "character_general_wrath", "character_warlord", "character_champion" },
