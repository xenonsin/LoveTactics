...
-- (models/class.lua's growthClasses), so a build leaning on skirmisher stock grows on THIS table.
...
return {
    damage = 3, stamina = 3, speed = 2, health = 3, -- survivability floor (Growth.ENEMY_DAMAGE_GROWTH)
}
