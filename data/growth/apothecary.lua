...
-- Lent vitality: heals before it strikes -- a supporting caster's growth.
-- Its own growth path: a discipline item tallies the discipline itself, not its parent class(es)
-- (models/class.lua's growthClasses), so a build leaning on apothecary stock grows on THIS table.
