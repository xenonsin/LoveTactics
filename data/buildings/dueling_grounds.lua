...
--
-- Gated on the Colosseum debut (data/quests/colosseum/slot_01_arena_debut.lua) rather than on prestige, which is the
...
return {
    ...
    panel = "pvp",
    unlockPrestige = 1,
    unlockQuest = "slot_01_arena_debut", -- see models/building.lua
}
