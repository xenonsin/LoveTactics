...
-- carries one narrow extra squeezed into its right-hand gutter (Dueling Grounds).
--
-- THE QUEST BOARD. The Adventurers' Guild board, where the seven houses post their work: the first card
-- in the city and the campaign's front door.
--
