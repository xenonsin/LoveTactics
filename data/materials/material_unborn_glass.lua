-- APEX TROPHY: what the Crucible's deep bodies pay for being put down a second time.
--
...
--
-- Dropped by Livia, the Unborn and by the lieutenant that stands below her, the general paying
...
return {
    name = "Unborn Glass",
    description = "Vessel glass that never held anything. It fogs when something near it is wanted.",
    sprite = "assets/materials/unborn_glass.png",
