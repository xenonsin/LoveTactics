-- APEX TROPHY: what the Arcanum's deep bodies pay for being put down a second time.
--
...
--
-- Dropped by Sublimitas, the Unequalled and by the lieutenant that stands below her, the general paying
...
return {
    name = "Margin Gilt",
    description = "Gilt scraped from the edge of a page. Every flake carries a word too small to read.",
    sprite = "assets/materials/margin_gilt.png",
