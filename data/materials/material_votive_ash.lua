-- APEX TROPHY: what the Cathedral's deep bodies pay for being put down a second time.
--
...
--
-- Dropped by Luxuria, the Unbidden and by the lieutenant that stands below her, the general paying
...
return {
    name = "Votive Ash",
    description = "What is left of something that was called and came. It keeps the shape of the bowl.",
    sprite = "assets/materials/votive_ash.png",
