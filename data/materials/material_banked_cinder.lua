-- APEX TROPHY: what the Colosseum's deep bodies pay for being put down a second time.
--
...
--
-- Dropped by Ira, the Unappeased and by the lieutenant that stands below her, the general paying
...
return {
    name = "Banked Cinder",
    description = "Still warm days later. Set it near a forge and the forge burns hotter than it was built to.",
    sprite = "assets/materials/banked_cinder.png",
