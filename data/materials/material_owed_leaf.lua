-- APEX TROPHY: what the Undercroft's deep bodies pay for being put down a second time.
--
...
--
-- Dropped by Aurea, the Ever-Owed and by the lieutenant that stands below her, the general paying
...
return {
    name = "Owed Leaf",
    description = "Gold beaten thinner than paper, stamped with a debt nobody living is owed.",
    sprite = "assets/materials/owed_leaf.png",
