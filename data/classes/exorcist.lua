...
-- what the enemy summons. (Xin embodies the same devotion but stays a root companion; the "starred
...
return {
    name    = "Exorcist",
    description = "Undoes what the enemy has built. Banish removes a summon from the field outright, and "
        .. "rites strip enemy buffs and clear hazards.",
    exemplar = "character_exorcist", -- was character_xin (a root companion); dedicated exemplar authored
    requires = { priest = 3 },
}
