...
-- the company's mage it is a serious injury: every spell now comes out of the health bar, and the share a
-- injury has already reserved cannot be healed back into (models/injury.lua). On a knight who casts
...
--
-- IT INJURIES AND NEVER FELLS. The conversion floors the caster at one health, which the spend path argues
