...
return {
    ...
    --   An arc does not have edges for an edge to work on.
    --   It has a path, and a heavy blow is a good way to interrupt one. So is standing it in water.
    resist = { lightning = 2, slash = 2, impact = -2, water = -4 },
