...
return {
    ...
    --   Everything it is owed is stacked on it, and stacked coin does not take a puncture.
    --   Stacked coin does come apart along the stack, which is what an edge is for.
    resist = { pierce = 5, slash = -5, dark = 5, holy = -10 },
