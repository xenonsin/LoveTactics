...
return {
    ...
    --   Ash holds its shape until something asks it to hold a shape.
    --   A spear asks nothing of it and passes through; an edge takes the whole silhouette apart at once.
