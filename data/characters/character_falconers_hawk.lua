-- THE FALCONER'S HAWK: the hawk fielded by the Falconer's Glove (data/traits/trait_falconers_hawk.lua). A spotter, not a
...
return {
    name = "Hawk",
    -- SPLIT FROM THE WOOD'S HAWK on review (2026-09-23): one blueprint was the glove's summon and the
    -- rift's bird at once, and the rift's got Swoop and Mantling (character_hawk). This one stays as it was.
    race = "beast",
    tier = 1,
    sprite = "assets/chars/falconers_hawk.png",
    stats = {
