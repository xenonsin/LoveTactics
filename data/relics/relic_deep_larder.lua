...
--
-- The clean answer to the injury meter (models/injury.lua) without undoing it: this gives HEALTH back
-- between fights, which is the resource a descent actually spends, and it cannot lift anybody past a
-- injury's ceiling because it pours through the same restore the hub does.
--
