...
-- cache -- the run boon you buy with a breather instead of a heal. The front line opens each fight
-- emboldened (status_heroism), a lasting edge in trade for the HP a Heal would have returned. Its weight
