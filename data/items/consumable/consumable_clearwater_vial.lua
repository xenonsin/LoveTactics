...
--
-- Deliberately the SAME effect as data/items/consumable/consumable_panacea.lua rather than a weaker one, because
...
return {
    ...
    description = "Removes every debuff from yourself.",
    flavor = "The apprentice's cure-all: for the troubles you can still lift a hand against.",
