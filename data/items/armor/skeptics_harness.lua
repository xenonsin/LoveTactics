...
return {
    ...
    description = "Magic isn't real. You cannot use it -- and it has a hard time happening to you. Heavy: -2 movement.",
    ...
    price = 460,
    repRank = 3,
    traits = { "magic_denial" }, -- lays Magic Denied at the bell; see data/status/magic_denied.lua
