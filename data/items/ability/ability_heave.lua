...
return {
    name = "Heave",
    description = "Grabs an adjacent body, banner, barrel or trap and throws it. A collision hurts both sides.",
    ...
    activeAbility = {
        ...
        damage = Curve.ramp(10, 20), -- the collision's bite (only a blocked throw lands it)
        effect = function(fx)
