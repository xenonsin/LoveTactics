...
-- the ground into restorative footing. Where the Wildcraft Poultice heals one body, this makes a patch
-- of the world heal anyone who stands on it: the field, brewed.
return {
    name = "Field Brew",
