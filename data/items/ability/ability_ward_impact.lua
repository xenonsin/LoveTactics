-- Ward: Impact -- a priest's protective blessing laid on the caster or a nearby ally, granting Resistant: Impact
...
-- blow the turn before it lands. It floors at 1 and never reaches immunity (that is the mage's Seal: Impact).
