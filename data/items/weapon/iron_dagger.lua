...
--
-- The Undercroft's entry-rank blade; data/items/weapon/kingsblood_dagger.lua is the rank-4 version of
-- this same idea, faster still and far dearer.
return {
    name = "Iron Dagger",
    description = "A short, quick blade. Its cuts keep bleeding -- and every step the victim takes costs it.",
    ...
    activeAbility = {
        ...
        effect = function(fx)
            fx.damage(fx.target)
            fx.applyStatus(fx.target, "bleed")
        end,
    },
}
