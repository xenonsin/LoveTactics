-- The axe archetype: axes cleave (docs/weapons.md). Like data/items/weapon/crimson_greataxe.lua this
...
return {
    name = "Iron Axe",
    description = "A short axe. Sweeps a wide arc, cutting everything standing in front of you.",
