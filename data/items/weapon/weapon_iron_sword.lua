...
return {
    name = "Iron Sword",
    description = "Strikes an adjacent foe, and answers an adjacent melee blow with one of its own.",
    flavor = "The blade everything else is measured against. Every other weapon buys its trick by giving up what this one keeps.",
