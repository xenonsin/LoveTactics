...
-- data/traits/trait_parry.lua with data/traits/trait_riposte.lua rather than carrying both. That swap
-- is the whole of what the price buys, and it is a difference in KIND, not degree. Both are priced
-- identically -- an answer costs what the swing that answers costs (docs/weapons.md, "Pricing a
-- triggered reflex") -- so what differs is only what that stamina buys:
--
...
return {
    ...
    flavor = "An ordinary sword takes the blow and answers it. This one declines the trade.",
