...
-- whatever stands in the line. Like the greataxe's cleave (data/items/weapon/weapon_crimson_greataxe.lua) the
...
return {
    ...
    flavor = "Reach is the whole argument. Everything else about it is a stick.",
