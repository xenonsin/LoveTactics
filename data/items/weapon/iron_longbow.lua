...
--
-- This is the same bargain data/items/weapon/iron_greatsword.lua makes in melee -- a turn spent
...
return {
    name = "Iron Longbow",
    description = "A tall bow drawn over a full turn, loosing an arrow from two tiles beyond a common bow's reach.",
    ...
    activeAbility = {
        target = "enemy",
        range = 5,     -- two tiles further than data/items/weapon/iron_bow.lua's 3
