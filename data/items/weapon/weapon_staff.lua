...
-- data/items/utility/utility_focus_stone.lua exists as a charm for anyone who wants Focus without a staff.
--
...
return {
    ...
    flavor = "The Arcanum's first staff. A mage's real constraint was never damage.",
