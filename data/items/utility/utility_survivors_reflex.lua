...
return {
    ...
    description = "Bloodied by a blow, you drink a healing potion on reflex, spending no turn.",
    flavor = "Pair it with the flasks and it is a second health bar. Carry it alone and it is a strap.",
