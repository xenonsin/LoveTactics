...
-- from data/items/armor/armor_mail_of_the_unappeased.lua, the mail YOU lift off her body, which carries the
...
return {
    ...
    description = "The nearer she is to death, the harder she hits.",
