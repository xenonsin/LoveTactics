...
-- (data/items/utility/utility_fire_stone.lua), through the 3x3 item grid it infuses the weapons and abilities
...
return {
    name = "Envenom",
    description = "Adjacent weapons and abilities inflict Poison on a hit.",
