...
-- spell that outruns its caster's mana is paid for out of an Azure Draught instead.
--
...
return {
    ...
    description = "A spell beyond your mana is drunk out of a flask instead. Bring mana draughts.",
