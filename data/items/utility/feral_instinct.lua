...
-- (data/items/utility/reprisal_quiver.lua) -- a passive utility whose whole effect is the Melee Counter
...
return {
    name = "Feral Instinct",
    description = "A cornered beast bites back: struck in melee, it strikes straight back with its fangs.",
