...
-- (or three) beside it and each swing heals you. Works exactly like the Fire Stone / Envenom auras
...
return {
    ...
    flavor = "Put a blade beside it, or three. Each swing heals what the last one cost you.",
    ...
    -- what it drinks keeps it standing -- the damage is the neighbour's
    bonus = { defense = 1 },
}
