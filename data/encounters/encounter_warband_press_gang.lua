...
--
-- `depth = 1` and the heaviest weight in the set: this is what the shallow floors should be meeting
...
return {
    ...
    composition = function(ctx)
        ...
        for _ = 1, math.floor((ctx.depth or 1) / 3) do list[#list + 1] = "character_bandit" end
        return list
    end,
}
