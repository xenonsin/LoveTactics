...
return {
    ...
    -- RUNG 2 -- the seat, and the argument above is the whole of it: the last thing the wood has. A
    -- company that has to corner something should have walked the approach first.
    rung = 2,
