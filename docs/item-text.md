...
- **A grid aura (an `aura` block) names the neighbours, then what they gain.** The form is
  `"Adjacent <types> gain <tag>."` / `"Adjacent <types> inflict <Status> on a hit."` — the Fire Stone
