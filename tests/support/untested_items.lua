...
return {
    ...
    -- THE 38 SIGNATURE RELICS, revealed rather than created. Each belonged to a discipline hire
    -- and carried `bound = true`, which kept it out of this ratchet entirely; the hires are gone and
    -- the relics are ordinary stock that drops from their discipline's own errand. The debt is as old
    -- as the items -- demoting them only made it countable. Same rule as every line above: delete on
    -- a test, never add.
    "armor_crowds_due",
    "armor_held_oath",
    "armor_marching_vow",
    "armor_standing_debt",
    "utility_bag_of_holding",
    "utility_borrowed_pelt",
    "utility_bound_mile",
    "utility_court_kept_waiting",
    "utility_cullers_basket",
    "utility_doorstone",
    "utility_dry_word",
    "utility_folded_word",
    "utility_fourth_shadow",
    "utility_ground_given",
    "utility_last_call",
    "utility_last_order",
    "utility_mother_vat",
    "utility_ninth_sigil",
    "utility_old_wind",
    "utility_open_ward",
    "utility_patient_line",
    "utility_quarrys_end",
    "utility_quiet_errand",
    "utility_red_account",
    "utility_rite_unspoken",
    "utility_sealed_bell",
    "utility_second_leash",
    "utility_second_reading",
    "utility_short_fuse",
    "utility_standing_order",
    "utility_standing_stone",
    "utility_the_signal",
    "utility_the_wedge",
    "utility_unbroken_vigil",
    "utility_unheld_hand",
