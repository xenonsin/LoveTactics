...
return {
    ...
    },
    {
        ...
        fn = function()
            local c = Combat.new(arena(8, 8), { unit("character_archer", 2, 2) }, {}) -- movement 4, sole unit
            local u = c.units[1]
            Combat.startTurn(c)
            ...
            local far = Combat.new(arena(8, 8), { unit("character_archer", 1, 1) }, {})
    ...
    },
    {
        ...
        fn = function()
            local c = Combat.new(arena(8, 8), { unit("character_mage", 4, 7) }, { unit("character_wolf_grunt", 4, 2) })
            local mage = c.units[1]
            mage.initiative = 0
    ...
    },
    {
        ...
        fn = function()
            ...
            local c = Combat.new(arena(8, 8),
                { unit("character_mage", 2, 2) }, { unit("character_bandit", 6, 6) })
            ...
            Status.apply(c, mage, "status_channeling")
    ...
    },
    {
        ...
        fn = function()
            local Status = require("models.status")
            local c = Combat.new(arena(8, 8), { unit("character_mage", 2, 2) }, { unit("character_bandit", 6, 6) })
            local mage = c.units[1]
            mage.char.inventory = { Item.instantiate("ability_fireball") }
            local fireball = mage.char.inventory[1]
    ...
    },
    {
        ...
        fn = function()
            ...
            local none = Combat.new(arena(8, 8), {}, { unit("character_bandit", 1, 1) })
    ...
    },
    {
        ...
        fn = function()
            ...
            Character.defs.test_beast = {
                ...
                stats = { health = 10, speed = 0 }, unarmed = "weapon_fangs",
            }
            local beast = Character.instantiate("test_beast")
            assert(beast.unarmed.id == "weapon_fangs", "blueprint unarmed override honoured")
    ...
    },
    {
        ...
        fn = function()
            ...
            -- default ACTION.
            assert(Combat.defaultWeapon(mage).id == "weapon_parasitic_staff", "the default weapon is unaffected")
        end,
    },
    {
    ...
    },
    {
        ...
        fn = function()
            ...
            local c = Combat.new(arena(8, 8),
                { unit("character_archer", 4, 4) },
                { unit("character_bandit", 5, 4), unit("character_bandit", 6, 4), unit("character_bandit", 7, 4) })
            local archer = c.units[1]
    ...
    },
    {
        ...
        fn = function()
            ...
            local c = Combat.new(arena(8, 8), { unit("character_archer", 4, 4) }, {})
            local archer = c.units[1]
    ...
    },
    {
        ...
        fn = function()
            ...
            assert(Status.has(bandit1, "status_root"), "Tangling Roots applies Root")

            rogue.char.inventory = { Item.instantiate("consumable_net") }
            openTurn(c, rogue)
            assert(Combat.useItem(c, rogue, rogue.char.inventory[1], bandit2.x, bandit2.y), "net throw lands")
            assert(Status.has(bandit2, "status_root"), "the Net applies Root")
        end,
    },
    ...
    -- ---------------------------------------------------------------------------
    {
        ...
        fn = function()
            local Status = require("models.status")
            local c = Combat.new(arena(8, 8),
                { unit("character_mage", 2, 2) }, { unit("character_bandit", 2, 4), unit("character_bandit", 3, 4) })
            ...
            assert(Status.has(mage, "status_channeling"), "the caster shows the Channeling badge")
    ...
    },
    {
        ...
        fn = function()
            local Status = require("models.status")
            local c = Combat.new(arena(8, 8),
                { unit("character_mage", 2, 2) }, { unit("character_bandit", 6, 6), unit("character_bandit", 1, 1) })
    ...
    },
    {
        ...
        fn = function()
            local Status = require("models.status")
            local c = Combat.new(arena(8, 8), { unit("character_mage", 2, 2) }, { unit("character_bandit", 2, 4) })
            ...
            Status.apply(c, mage, "status_stun")
    ...
    },
    {
        ...
        fn = function()
            ...
            Status.apply(c, mage, "status_stun")
            assert(mage.channel == nil, "the stun shatters the channel")
            assert(not Status.has(mage, "status_channeling"), "the Channeling badge is cleared")
    ...
    },
    {
        ...
        fn = function()
            local c = Combat.new(arena(8, 8), { unit("character_mage", 4, 4) }, { unit("character_bandit", 4, 6) })
            local mage, b1 = c.units[1], c.units[2]
            mage.char.inventory = { Item.instantiate("ability_fireball") }
            mage.initiative, b1.initiative = 0, 1
            openTurn(c, mage)
    ...
    },
    {
        ...
        fn = function()
            local c = Combat.new(arena(10, 10), { unit("character_mage", 2, 2) }, { unit("character_bandit", 2, 4) })
            local mage, b1 = c.units[1], c.units[2]
            mage.char.inventory = { Item.instantiate("ability_fireball") }
            mage.initiative, b1.initiative = 0, 1
            openTurn(c, mage)
    ...
    },
    {
        ...
        fn = function()
            ...
            rogue.char.inventory[4] = Item.instantiate("weapon_iron_sword")       -- speed 3
            rogue.char.inventory[6] = Item.instantiate("weapon_homunculus_fists") -- 1h melee, poisons on hit
    ...
    },
    {
        ...
        fn = function()
            ...
            rogue.char.inventory = {}
            rogue.char.inventory[5] = dual
            rogue.char.inventory[4] = Item.instantiate("weapon_iron_sword") -- one 1h weapon: not enough alone
            ...
            rogue.char.inventory[6] = Item.instantiate("weapon_crimson_greataxe") -- hands = 2
    ...
    },
    {
        ...
        fn = function()
            local function armedCount(level)
                ...
                rogue.char.inventory[2] = Item.instantiate("weapon_iron_sword")
                rogue.char.inventory[4] = Item.instantiate("weapon_iron_sword")
                rogue.char.inventory[6] = Item.instantiate("weapon_iron_sword")
    ...
    },
    {
        ...
        fn = function()
            ...
            knight.inventory[4] = Item.instantiate("weapon_iron_sword") -- speed 3, adjacent
            knight.inventory[6] = Item.instantiate("weapon_iron_hammer") -- speed 7 but 2h: excluded at +0
            ...
            knight.inventory[2] = Item.instantiate("weapon_iron_sword") -- speed 3, adjacent to 5
    ...
    },
    {
        ...
        fn = function()
            local function boostTargets(level)
                ...
                knight.inventory[4] = Item.instantiate("weapon_iron_sword")
                knight.inventory[6] = Item.instantiate("weapon_iron_sword")
                knight.inventory[8] = Item.instantiate("weapon_iron_bow") -- ranged: never qualifies
                local to = {}
