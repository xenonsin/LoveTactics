...
return {
    ...
    },
    {
        ...
        fn = function()
            ...
            -- `unlockLevel`. The two agree on a priced ware and part on a found one, whose rung is its
            ...
            local function rankOf(row) return row.entry.rung or row.entry.unlockLevel or 0 end
