...
return {
    ...
    },
    {
        ...
        fn = function()
            ...
            local bare = Status.resistedDuration(a, "sleep", 14)
            local warded = Status.resistedDuration(b, "sleep", 14)
    ...
    },
    {
        ...
        fn = function()
            ...
            for i = 1, 6 do
                ...
                if s then Status.remove(c, bandit, "sleep") end -- clear the badge; keep the history
            end
    ...
    },
    {
        ...
        fn = function()
            ...
            repeat
                casts = casts + 1
                local s = Status.apply(c, bandit, "sleep")
                if s then Status.remove(c, bandit, "sleep") end
            ...
            local afterRefusal = Status.timesAfflicted(bandit, "sleep")
            assert(Status.apply(c, bandit, "sleep") == nil, "it is still refused")
            assert(Status.timesAfflicted(bandit, "sleep") == afterRefusal + 1,
    ...
    },
    {
        ...
        fn = function()
            ...
            Character.addItem(knight.char, Item.instantiate("skeptics_harness"))
            ...
            assert(Status.resistedDuration(knight, "polymorph", 12)
                < Status.resistedDuration({ char = { stats = { magicDefense = 0 } } }, "polymorph", 12),
    ...
    },
    {
        ...
        fn = function()
            ...
            assert(Status.resistedDuration(knight, "regen", 10) == 10, "a buff is never resisted")
            local s = Status.apply(c, knight, "stun")
            assert(s and s.remaining == Status.defs.stun.duration, "and Stun still lands as authored")
        end,
    },
}
