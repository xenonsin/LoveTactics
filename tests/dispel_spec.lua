...
return {
    {
        ...
        fn = function()
            ...
            Status.apply(c, bandit, "status_invisible")
            ...
            assert(not Status.has(bandit, "status_invisible"), "and its Invisible is stripped")
    ...
    },
    {
        ...
        fn = function()
            ...
            assert(not Status.has(bandit, "status_invisible"), "the hidden bandit is revealed")
    ...
    },
    {
        ...
        fn = function()
            ...
            Wall.defs.test_stone = { name = "Stone Wall", health = 30, sightCost = 2,
                tags = { "structure" } }
            local c = Combat.new(arena(6, 6), { unit("character_priest", 1, 1) }, {})
